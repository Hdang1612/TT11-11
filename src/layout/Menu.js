  ...
  return (
    <div className="absolute bottom-0 left-0 w-full bg-[#EDEDED] shadow-lg z-50 py-1 px-5 md:px-[120px]">
      <div className="flex justify-between items-center">
        ...
        <Link
          // to="/reminder"
          className={`flex flex-col items-center md:py-3 ${isActive("/reminder") ? "text-[#EF8767]" : ""}`} 
        >
        ...
        <Link
          // to="/receipt"
          className={`flex flex-col items-center md:py-3 ${isActive("/receipt") ? "text-[#EF8767]" : ""}`}
        >
        ...
        <div className="relative flex flex-col items-center justify-center">
          <Link
            to="/add-expense"
            className="absolute bottom-0 -translate-y-[0px] md:translate-y-[-10px]"
          >
        ...
        <Link
          to="/statistics"
          className={`flex flex-col items-center md:py-3 ${isActive("/statistics") ? "text-[#EF8767]" : ""}`} 
        >
        ...
        <Link
          to="/"
          className={`flex flex-col items-center md:py-3 ${isActive("/") ? "text-[#EF8767]" : ""}`} 
        >
